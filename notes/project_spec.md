...
130. Task 25 freezes a 500-word plain-language answer and a 136-word abstract-level answer. Wherever the structured neural interface is motivated, its empirical component grades, poor usable coverage, exact transfer-versus-abstention mnemonic, and noncausal dead-band qualification remain in the same argumentative unit.
