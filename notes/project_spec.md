...
Status: living specification, version 2.0 after decisive-experiment preregistration
Created: 2026-07-10  
...
92. The final confirmation role is embargoed until a disjoint Task 19A pilot freezes manifests, power, seeds, stopping, and hashes. Hard MoE proceeds only under its separate powered conforming-versus-mismatched seam gate; the system extension separately connects learned grade envelopes to checked composite certificates and uses lower-ranked audit evidence before untouched confirmation. Neither extension may reduce core power, and activation alignment is exploratory.
...
- independent generator/oracle construction, disjoint pilot validation/power analysis, and a machine-readable frozen five-role protocol before learner implementation (Task 19A);
