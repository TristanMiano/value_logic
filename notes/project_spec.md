...
Status: living specification, version 3.8 after Task 31B publication repair
Created: 2026-07-10  
...
- Task 32's Gist-compatible formatting and render validation;
- Task 33's Substack adaptation; and
- Task 34's final claim-by-claim cross-check.

Task 31B has repaired the known public exposition and delimiter defects.
Tasks 32--34 are packaging and cross-check construction targets. None is a
